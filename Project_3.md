...
##### To run the linear model, I created training and test data with a 4/5 split. 

##### Below is the plot of population sums generated by the linear model. 
![plot](populationsums.png)

##### Below is a plot showing the difference between the actual population sums and those predicted by the model. It appears that the model has underpredicted the population all over.
![plot](diffsums.png)

#### The sum of the population sums from the model equals 1809074. The sum of the population 
