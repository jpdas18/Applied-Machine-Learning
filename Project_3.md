...
##### To run the linear model, I modeled predicitions using geographic coordinates and the sum of all the variables (water, dst011, dst040, dst130, dst140, dst150, dst160, dst190, dst200, topo, slope, ntl). 

##### Below is the plot of population sums generated by the linear model. 
![plot](populationsums.png)

##### Below is a plot showing the difference between the actual population sums and those predicted by the model. It appears that the model has underpredicted the population.
![plot](diffsums.png)
